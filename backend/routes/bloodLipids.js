...
// GET /api/blood-lipids/stats
// Returns the most recent value+date, the last 3 records with scores, and their average
router.get("/stats", verifyToken, async (req, res) => {
  try {
    ...
    const recentRecords = rows.map(r => ({
      ...
      score: getNonHDLScore(Number(r.value)),
      date: r.created_at,
    }));
    ...
    console.error("[GET /api/blood-lipids/stats] Error:", error);
